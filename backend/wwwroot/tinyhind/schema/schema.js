...
// pages/tinyhind/schema/schema.ts
var schemaRoot = document.getElementById("schema-root");
var tiny = new TinyHindClient("", TENANT_ID);
function toggleSchemaDetails(tableName) {
...
var form = document.getElementById("schema-builder-form");
...
async function handleFormSubmit(event) {
  ...
  propertyRows.forEach((row) => {
    ...
    const requiredCheckbox = row.querySelector(".prop-required");
...
window.toggleSchemaDetails = toggleSchemaDetails;
loadSchemas();
initializeBuilder();
